...
import {useSignupMutation} from '../../store/api/registerApi';
                        ...
                        <Box className="w-full">
                            <Card className="px-5">
                                ...
                                <CardContent className="my-10">
                                    ...
                                    <Divider />
                                    <TextField name="name" value={name} onChange={handleChange} label="name" className='w-full py-3 my-3' />
                                    <Divider />
                                    <TextField name="phone" value={phone} onChange={handleChange} label="phone" className='w-full py-3 my-3' />      
                                    <Divider />
                                    <TextField name="address" value={address} onChange={handleChange} label="address" className='w-full py-3 my-3' />   
                                    <FormGroup>
                                        {/* <FormControlLabel control={<Switch checked={false} />} label="remember me" />     */}
                                    </FormGroup>
                                    <Box className="my-3">      
                                        <Button onClick={handleSignup} className="bg-emerald-200" variant='contained' fullWidth>SIGN UP</Button>
                                    </Box> 
                                </CardContent>
